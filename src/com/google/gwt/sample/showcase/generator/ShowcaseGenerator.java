...
public class ShowcaseGenerator extends Generator {
	/**
	 * The paths to the CSS style sheets used in Showcase. The paths are
	 * relative to the root path of the {@link ClassLoader}. The variable $THEME
	 * will be replaced by the current theme. The variable $RTL will be replaced
	 * by "_rtl" for RTL locales.
	 */
	private static final String[] SRC_CSS = { "com/google/gwt/user/theme/$THEME/public/gwt/$THEME/$THEME$RTL.css",
	 ...
	 *            the {@link ContentWidget} subclass
	 * @param styleDefs
	 *            the concatenated style definitions
	 * @param outDir
	 *            the output directory
	 */
	private void generateStyleFiles(JClassType type, String styleDefs, String outDir) throws UnableToCompleteException {
		// Look for annotation
	 ...
	 */
	private String getStyleDefinitions(String theme, boolean isRTL) throws UnableToCompleteException {
		String cssContents = "";
