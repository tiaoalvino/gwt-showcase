...
public abstract class ContentWidget extends SimpleLayoutPanel implements HasValueChangeHandlers<String> {
	 ...
	 *            the text name of the example
	 * @param description
	 *            a safe html description of the example
	 * @param hasStyle
	 *            true if the example has associated styles
	 * @param rawSourceFiles
	 *            the list of raw source files to include
	 */
	public ContentWidget(String name, SafeHtml description, boolean hasStyle, String... rawSourceFiles) {
		this.name = name;
	 ...
	 * @param urlSuffix
	 *            the URL to target, relative to the Showcase module's base URL.
	 */
	private void sendSourceRequest(RequestCallback callback, String urlSuffix) {
		// When Super Dev Mode is on, we will load it from the code server, not
		// the original server.
